...
*AGP damage estimates vs metaDMG reference-based estimates for 31 ancient environmental samples. Green points: Channel B validated. Red squares: rejected as compositional artifacts. r = 0.89.*
