...
// Legacy compatibility functions (for code that still uses them)
const std::unordered_map<std::string, float>& get_codon_frequencies() {
    static const std::unordered_map<std::string, float> freqs = {
        {"TTT", 0.57f}, {"TTC", 0.43f}, {"TTA", 0.11f}, {"TTG", 0.11f},
        {"TCT", 0.17f}, {"TCC", 0.15f}, {"TCA", 0.14f}, {"TCG", 0.14f},
        {"TAT", 0.59f}, {"TAC", 0.41f}, {"TAA", 0.61f}, {"TAG", 0.09f},
        {"TGT", 0.46f}, {"TGC", 0.54f}, {"TGA", 0.30f}, {"TGG", 1.00f},
        {"CTT", 0.10f}, {"CTC", 0.10f}, {"CTA", 0.03f}, {"CTG", 0.55f},
        {"CCT", 0.18f}, {"CCC", 0.13f}, {"CCA", 0.20f}, {"CCG", 0.49f},
        {"CAT", 0.57f}, {"CAC", 0.43f}, {"CAA", 0.34f}, {"CAG", 0.66f},
        {"CGT", 0.36f}, {"CGC", 0.36f}, {"CGA", 0.07f}, {"CGG", 0.11f},
        {"ATT", 0.49f}, {"ATC", 0.39f}, {"ATA", 0.11f}, {"ATG", 1.00f},
        {"ACT", 0.19f}, {"ACC", 0.40f}, {"ACA", 0.17f}, {"ACG", 0.25f},
        {"AAT", 0.49f}, {"AAC", 0.51f}, {"AAA", 0.74f}, {"AAG", 0.26f},
        {"AGT", 0.16f}, {"AGC", 0.25f}, {"AGA", 0.07f}, {"AGG", 0.04f},
        {"GTT", 0.28f}, {"GTC", 0.20f}, {"GTA", 0.17f}, {"GTG", 0.35f},
        {"GCT", 0.18f}, {"GCC", 0.26f}, {"GCA", 0.23f}, {"GCG", 0.33f},
        {"GAT", 0.63f}, {"GAC", 0.37f}, {"GAA", 0.68f}, {"GAG", 0.32f},
        {"GGT", 0.35f}, {"GGC", 0.37f}, {"GGA", 0.13f}, {"GGG", 0.15f}
    };
    return freqs;
}

const std::unordered_map<char, float>& get_aa_frequencies() {
    static const std::unordered_map<char, float> freqs = {
        {'A', 0.082569f}, {'C', 0.013888f}, {'D', 0.054628f}, {'E', 0.067171f},
        {'F', 0.038694f}, {'G', 0.070735f}, {'H', 0.022788f}, {'I', 0.059073f},
        {'K', 0.057985f}, {'L', 0.096498f}, {'M', 0.024120f}, {'N', 0.040637f},
        {'P', 0.047481f}, {'Q', 0.039324f}, {'R', 0.055287f}, {'S', 0.066602f},
        {'T', 0.053658f}, {'V', 0.068565f}, {'W', 0.011053f}, {'Y', 0.029246f}
    };
    return freqs;
}
...
char codon_to_aa(const std::string& codon) {
    ...
    return translate_codon_fast(codon[0], codon[1], codon[2]);
}

std::vector<std::string> get_codons_for_aa(char aa) {
    static const std::unordered_map<char, std::vector<std::string>> aa_to_codons = {
        {'F', {"TTT", "TTC"}},
    ...
    if (it != aa_to_codons.end()) return it->second;
    return {};
}

float get_aa_prior(char aa) {
    return get_aa_freq_fast(aa);
}

float get_codon_usage_within_aa(const std::string& codon, char aa) {
    if (codon.length() != 3) return 0.1f;
    return get_codon_freq_fast(codon[0], codon[1], codon[2]);
}
